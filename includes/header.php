...
<aside>
    ...
    <a href="/miembros/acuarela-app-web/administrador-tareas" class="<?=$_GET['activeTab'] == 5 ? 'active':''?>"><i class="acuarela acuarela-Checklist"></i><span data-translate="193">Administrador de tareas</span></a>
    <?php 
