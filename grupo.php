...
?>
  <div class="content">
    <div class="contentHeader">
      <h2>Reporte</h2>
      <button type="button" onclick="showActivityLightbox()" class="btn btn-action-primary enfasis btn-big">Agregar actividad</button>
    </div>
    ...
    <?php 
      ...
      foreach ($grupo->rates as $activity) {
          echo '<li onclick="showActivityLightbox()">';
